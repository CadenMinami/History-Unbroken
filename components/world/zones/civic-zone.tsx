...
export function CivicZone({
  ...
  return (
    <group>
      <group position={e1Position} userData={{ cameraOcclusion: true }}>
        ...
        <mesh position={[0, 1.47, -0.08]} rotation={[-0.3, 0, 0]} scale={[0.72, 0.04, 0.5]}>
          <boxGeometry />
          <meshStandardMaterial color="#c7bda6" roughness={0.9} />
        </mesh>
      </group>
      ...
      <group position={civicStationPosition} userData={{ cameraOcclusion: true }}>
