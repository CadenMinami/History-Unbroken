...
const e2ePort = resolvePlaywrightPort({
  UNCHANGED_E2E_PORT: process.env.UNCHANGED_E2E_PORT,
});
const e2eBaseUrl = `http://127.0.0.1:${e2ePort}`;
const requiresFreshProductionServer =
  process.env.UNCHANGED_PERFORMANCE === "1";
